#!/usr/bin/python
#usage python tryharder_pattern_findoffset.py 127.0.0.1
#my result found with !mona findmsp , Address=0BADF00D Message=    ESP (0x0016f2f0) points at offset 497 in normal pattern (length 14) -> offset=1000+493 = 1497
